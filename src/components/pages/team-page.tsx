    ...
    <main id="main">
      <section className="border-b border-outline/40">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          ...
          />
          <div className="mt-10 grid gap-6 rounded-[1.9rem] border border-outline/50 bg-white/84 p-5 shadow-soft sm:mt-12 sm:rounded-[2.25rem] sm:p-8 lg:grid-cols-[0.86fr_1.14fr] lg:items-center">
            <ArtImage mediaKey="founderPortrait" className="hidden sm:block" aspect="aspect-[4/4.35]" filter="sepia(0.15) saturate(0.88) contrast(1.02)" />
            <div>
              <p className="text-[0.72rem] font-semibold uppercase tracking-[0.2em] text-terracotta">Victoria Inaudi (Vik) · {dictionary.team.founderRole}</p>
      ...
      {featuredMember && dictionary.team.featuredTitle && dictionary.team.featuredIntro ? (
        <section className="border-b border-outline/40 bg-surface/45">
          <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
            <div className="grid gap-6 lg:grid-cols-[0.96fr_1.04fr] lg:items-center">
              ...
              <div className="rounded-[1.75rem] border border-outline/50 bg-white/84 p-6 shadow-soft sm:rounded-[2rem] sm:p-8">
      ...
      <section className="border-t border-outline/40 bg-surface/45">
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
          <div className="rounded-[1.8rem] border border-outline/50 bg-white/84 px-5 py-6 shadow-soft sm:flex sm:items-center sm:justify-between sm:gap-6 sm:rounded-[2rem] sm:px-8 sm:py-8">
            <h2 className="max-w-2xl font-display text-[2rem] leading-tight text-ink sm:text-3xl">{dictionary.team.hero.description}</h2>
